...
public class PanelJeu extends JPanel {
	...
	private JRadioButton jrb_1 = new JRadioButton("1");
	private JRadioButton jrb_2 = new JRadioButton("2");
	private JPanel jp_nbrJoueur = new JPanel();
	private JLabel jl_taillePlateau = new JLabel("Quelle dimension de plateau ");
	private JTextField jtf_taillePlateau = new JTextField();
	...
	public void parametre(){
		...
		jp_param.add(jl_joueur);
		jp_param.add(jp_nbrJoueur);
		jp_param.add(jl_taillePlateau);
		jp_param.add(jtf_taillePlateau);
